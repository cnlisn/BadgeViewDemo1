...
public class ViewsFragment extends Fragment implements OnClickListener {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        //第一个参数控制圆角角度
        backgroundShapeBadge.setBackground(5, Color.parseColor("#9b2eef"));
    ...
    public void onClick(View v) {
        switch (v.getId()) {
            case R.id.counter: {
                ...
                //数量减1
//                counterBadge.decrementBadgeCount(1);
                break;
            }

            case R.id.gravity: {
                gravityBadge.incrementBadgeCount(1);
                Log.e(getClass().getName(), String.valueOf(gravityBadge.getBadgeCount() % 9));
